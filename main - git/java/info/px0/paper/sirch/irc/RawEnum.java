...
public class RawEnum {
    ...
    public enum RawVal {
        ...
        RplYourHost (002) { // :Your host is <server>, running version <ver>
            @Override
            public String toString() { return "002"; }
        },

        RplNamReply (353) {  // :192.168.183.170 353 bot = #mp3 :bot @serv
            @Override
            public String toString() { return "353"; }
        },

        RplEndOfNames (366) {  // :192.168.183.170 366 bot #mp3 :End of /NAMES list. (AKA Room joined)
            @Override
            public String toString() { return "366"; }
        },

        RplMotdEnd (376) { // :End of /MOTD command.
            @Override
            public String toString() { return "376"; }
        },

        ErrCannotSendToChan (404) { // :server 404 nickname #channel :msg
            @Override
            public String toString() { return "404"; }
        },

        ErrNoMotd (422) { // :MOTD File is missing
            @Override
            public String toString() { return "422"; }
        },

        ErrNoNicknameGiven (431) { // :No nickname given
            @Override
            public String toString() { return "431"; }
        },

        ErrErroneusNickname (432) { // <nickname> :Erroneus Nickname
            @Override
            public String toString() { return "432"; }
        },

        ErrNickNameInUse (433) {  // <nickname> :Nickname is already in use.
            @Override
            public String toString() { return "433"; }
        };

        private final int value;
        private RawVal(final int value) {
            this.value = value;
        }

        private static final Map<Integer, RawVal> BY_CODE_MAP = new LinkedHashMap<Integer, RawVal>();
        static {
            for (RawVal rae : RawVal.values()) {
                BY_CODE_MAP.put(rae.value, rae);
            }
        }

        public static RawVal forValue(int value) {
